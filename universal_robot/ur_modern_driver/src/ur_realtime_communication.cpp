...
void UrRealtimeCommunication::setSpeed(double q0, double q1, double q2,
	...
	if (q0 != 0. or q1 != 0. or q2 != 0. or q3 != 0. or q4 != 0. or q5 != 0.) {
		...
		addCommandToQueue("stopj(100)\n");
		// printf("Stop(zero velocity)\n");
	}
}


void UrRealtimeCommunication::stopj() {
	
	addCommandToQueue("stopj(100)\n");
	printf("Stop(due to no topic received),  Safety Count: %u\n", safety_count_);
